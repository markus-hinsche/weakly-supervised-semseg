...
from ..util import (
    ...
    REGEX_IMG_FILE_NAME,
    REGEX_IMG_FILE_NAME,
    REGEX_IMG_FILE_NAME_WITH_LABEL_VECTOR,
    is_in_set_n1,
    has_a_valid_color,
)
...
def test_has_a_valid_color():
    path = (
        Path(__file__).parent / "test_data" / "top_mosaic_09cm_area38_tile1_11001.tif"
    )
...
def test_has_not_a_valid_color():
    path = (
        Path(__file__).parent / "test_data" / "top_mosaic_09cm_area38_tile1_00000.tif"
    )
